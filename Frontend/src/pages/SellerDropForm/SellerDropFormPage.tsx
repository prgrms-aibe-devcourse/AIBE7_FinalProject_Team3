...
export default function SellerDropFormPage({ notify }: { notify: (message: string) => void }) {
  ...
  return (
    <section className="page-section form-page">
      ...
      <form onSubmit={submit}>
        ...
        <section className="form-card">
          <div className="section-number">02</div><div className="form-content"><OptionGroupBuilder /></div>
        </section>
        <section className="form-card">
